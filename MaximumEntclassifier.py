...
if __name__ == '__main__':
  ...
  text_maxEnt = Pipeline([('vect', CountVectorizer()), 
                        ('tfidf', TfidfTransformer(norm = 'l2', use_idf = True, smooth_idf = True, sublinear_tf = True)),
                        ('clf', LogisticRegression(random_state=1111, warm_start=False, penalty='l2')),
                       ]) 

  text_train = text_maxEnt.fit(st, train_instances)
